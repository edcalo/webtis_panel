        ...
        <div class="wrapper_carousel shadow">
            <ul id="mycarousel" class="jcarousel-skin-home">
                ...
                foreach ($empresas as $empresa) {
                    echo "<li>" . $this->Html->image("logo/" . $empresa->image, array("alt" => "Brownies", "class" => "hover"));
                    echo $this->Html->image("logo/" . $empresa->image_hover, array("alt" => "Brownies", "class" => "normal")) . "</li>";
                }
                ?>
            </ul>	
        </div>
